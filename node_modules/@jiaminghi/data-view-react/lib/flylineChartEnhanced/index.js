...
var autoResize = require('../autoResize-e4408d76.js');
var index$1 = require('../index-4a59a5ac.js');
var index$1$1 = require('../index-c73e2a47.js');
...
var FlyLineChartEnhanced = React.forwardRef(function (_ref3, ref) {
  ...
  function getMergedConfig() {
    ...
    mergedConfig.points = points.map(function (item) {
      item.halo = index$1$1.util_2(index$1$1.util_1(halo, true), item.halo || {});
      item.text = index$1$1.util_2(index$1$1.util_1(text, true), item.text || {});
      item.icon = index$1$1.util_2(index$1$1.util_1(icon, true), item.icon || {});
      return item;
    });

    mergedConfig.lines = lines.map(function (item) {
      return index$1$1.util_2(index$1$1.util_1(line, true), item);
    });
